...
The code below shows how to use the `bootstrap` and `BootSummary` functions to conduct bootstrap and obtain the summary: 
...
>>>>>>> 7e17844cc32f98403d50272f377653700a77576d
